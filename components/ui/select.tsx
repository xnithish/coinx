    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1",
            position === "popper" && "cursor-pointerh-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)] scroll-my-1"
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(" cursor-pointer bg-border pointer-events-none -mx-1 my-1 h-px", className)}
      {...props}
    />
  )
}
